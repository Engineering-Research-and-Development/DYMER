...
let result = Vvveb.baseUrl.replace("libs/builder/", "");
let url=result + "resources/google-fonts.json"
console.log(url)
fetch(url)
.then((response) => {
...
.catch(error => {
	...
	//TODO check displayToast("bg-danger", "Error", "Error loading google fonts!");
});
