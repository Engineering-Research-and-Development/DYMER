...
//     properties: [
//         {
//             key: "searchable_header",
//             inputtype: SectionInput,
//             name: false,
//             sort: base_sort++,
//             data: { header: "Searchable", expanded: false },
//         },
//         {
...
//         let found = this.properties.find(el => el.key == "searchable_header");
//         let searchLabel = this.properties.find(el => el.name == "Searchable-label");
//         let ele = this.properties.indexOf(found)
//         let eleLAbel = this.properties.indexOf(searchLabel)
//         console.log("PROPERTIES", this.properties)
//         found ?
//             (
//                 $(node)[0].nodeName !== "INPUT" ?
//                     (
//                         console.log("NON E' INPUT"),
//                         this.properties.splice(eleLAbel, 1),
//                         this.properties.splice(ele, 1),
//                         console.log("ELE TOLTO PROPER", this.properties)
//                     )
//                     : console.log("E' INPUT")
//             ) : (
//                 console.log("NON TROVATO SEARCHABLE!"),
//                 console.log("PROPERTIES", this.properties)
//             )
//     },
// });
...
Vvveb.Components.extend("_base", "html/repeatable", {
    nodes: ["div"],
    image: "icons/container.svg",
    html: '<div class="form-group repeatable first-repeatable">' +
        '<div>' +
        '</div></div>',
    name: "Repeatable",
    properties: [{
        ...
        onChange: function (node, value) {
            if (value == true) {
                ...
                var act =
                    ...
                    "</div>";
                $(node).closest('.form-group').append(act);
            } else {
                $(node).closest('.form-group').removeClass("repeatable first-repeatable");
...
Vvveb.Components.extend("_base", "html/textareainput", {
    ...
    html: '<div class="form-group"><label>Your response:</label><textarea type="textarea" class="form-control"></textarea></div>',
    properties: [{
        name: "Name",
        key: "name",
        htmlAttr: "name",
