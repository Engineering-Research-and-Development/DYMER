...
Vvveb.ComponentsGroup['Elements'] = [
    ...
    Vvveb.Components.add("elements/gallery", {
        ...
        html: `
                <div class="gallery masonry has-shadow" data-component-gallery>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/7.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/2.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/15.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/4.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/5.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
                            <img src="`+ Vvveb.baseUrl +`media/6.jpg">
                        </a>
                    </div>
                    <div class="item">
                        <a>
            ...
            properties: [{
                ...
                onChange: function(node) {
                     $(node).append('<div class="item"><a><img src="'+ Vvveb.baseUrl +'media/15.jpg"></a></div>');
        ...
        html: `<div class="flip-box enabled">
              <div class="flip-box-inner">
                <div class="flip-box-front">
                      <div class="card">
                      <img src="`+ Vvveb.baseUrl +`media/1.jpg" class="card-img-top" alt="Post">
                      <div class="card-body">
                ...
                <div class="flip-box-back">
                    <div class="d-flex align-items-center flex-column">
                      <div class="flex-shrink-0">
                        <img src="`+ Vvveb.baseUrl +`media/2.jpg" alt="Post">
                      </div>
    ...
    function carouselAfterDrop(node) {
        ...
        {
            let swiperScript = `<script id="swiper-js" src="`+ Vvveb.baseUrl +`swiper/swiper-bundle.min.js"></script> 
            <link id="swiper-css" href="`+ Vvveb.baseUrl +`swiper/swiper-bundle.min.css" rel="stylesheet">
            <script>
            var swiper = [];
        ...
        html: `
          <div class="swiper" data-slides-per-view="3" data-draggable="true">
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/1.jpg" class="img-fluid"><p>Slide 1</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/2.jpg" class="img-fluid"><p>Slide 2</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/3.jpg" class="img-fluid"><p>Slide 3</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/4.jpg" class="img-fluid"><p>Slide 4</p></div>
            </div>
            ...
            onChange: function(node, value, input, component, event) {
                ...
                if (event.action) {
                    if (event.action == "add") {
                        ...
                        element.swiper.appendSlide(`<div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/${random}.jpg" class="img-fluid"><p>Slide ${index}</p></div>`);
        ...
        image: "icons/slider.svg",
         html: `
          <div class="swiper" data-slides-per-view="1" data-draggable="true" data-navigation='{"nextEl": ".swiper-button-next","prevEl": ".swiper-button-prev"}'>
            <div class="swiper-wrapper">
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/1.jpg" class="img-fluid"><p>Slider 1</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/2.jpg" class="img-fluid"><p>Slider 2</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/3.jpg" class="img-fluid"><p>Slider 3</p></div>
              <div class="swiper-slide"><img src="`+ Vvveb.baseUrl +`media/4.jpg" class="img-fluid"><p>Slider 4</p></div>
            </div>
            <div class="swiper-pagination"></div>
