...
Handlebars.registerHelper('EntityLike', function (obj, hookCheckSatusconf,iconup,icondown) {
    ...
    if (likes.includes(userDYM.email)) {
        ...
        likeBtn += '<a href="#" class="likeCount" id="viewlike'+obj._id+'"> <span id="likeBtn-' + obj._id + '" class="fa '+iconup+' active" style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" data-html="true" title="' + likesList + '" ' + ' onclick="like(\'' + obj._id + '\',\'' + obj.title.replace(/['"]/g, '') + '\', \'' + obj._index + '\', \'' + userDYM.email + '\', \'' + userDYM.roles + '\', \'' + iconup + '\', \'' + icondown + '\')"> ' + nLikes + ' </a>'
    } else {
        likeBtn += '<a href="#" class="likeCount" id="viewlike'+obj._id+'"> <span id="likeBtn-' + obj._id + '" class="fa '+icondown+'" style="cursor:pointer" data-toggle="tooltip" data-placement="bottom" data-html="true" title="' + likesList + '" ' + ' onclick="like(\'' + obj._id + '\',\'' + obj.title.replace(/['"]/g, '') + '\', \'' + obj._index + '\', \'' + userDYM.email + '\', \'' + userDYM.roles + '\', \'' + iconup + '\',\'' + icondown + '\')"> ' + nLikes + ' </a>'
    }
    ret = likeBtn;
    return ret
});
