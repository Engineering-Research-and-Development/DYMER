...
Handlebars.registerHelper('EntityStatusPdf', function(obj, hookCheckSatusconf, obj2) {
    ...
    if (perm.delete || perm.edit) {
        if (actualTemplateType == 'fullcontent') {
            ...
            editBtn += '&nbsp;&nbsp;<span id="exportBtn" class="text-warning  " style="cursor:pointer" onclick="exportPDFEntity(\'' + obj._id + '\',\'' + obj.title + '\', \'' + dviewtype + '\')"> <b> <i class="fa fa-download" aria-hidden="true"></i></b> <span> PDF Export </span> </span>';
            editBtn += '</div>';
