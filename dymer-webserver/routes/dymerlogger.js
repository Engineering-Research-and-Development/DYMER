...
exports.flushfile = function (typefile) {
	let typefilepath = './logs/' + typefile + '.log';
	fs.writeFile(typefilepath, '', function () {
		console.log('flushed ' + typefilepath)
	})
};
exports.flushAllfile = function () {
	let typefilepath1 = './logs/info.log';
	fs.writeFile(typefilepath1, '', function (typefilepath) {
		console.log('flushed' + typefilepath1)
	})
	let typefilepath2 = './logs/error.log';
	fs.writeFile(typefilepath2, '', function (typefilepath) {
		console.log('flushed ' + typefilepath2)
	})
};
