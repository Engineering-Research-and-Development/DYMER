...
router.use('*', redirectLogin, async(req, res, next) => {
    ...
    //console.log(" entity.js | * | req.headers ", JSON.stringify(req.headers));
    //console.log(" entity.js | * | req.session ", JSON.stringify(req.session));
...
let allowedOrigins =util.getAllowedOrigins("dymer-entities")//VL new gui
