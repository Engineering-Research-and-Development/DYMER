...
import { TemplateFile } from '../templates.interface';
...
export class CanvasTemplatesComponent implements AfterViewInit, OnDestroy {
  ...
  injectAttachments(files: TemplateFile[]) {
