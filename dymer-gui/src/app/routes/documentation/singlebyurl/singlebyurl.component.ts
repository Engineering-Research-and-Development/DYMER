...
import { SingleByUrlService } from './singlebyurl.service';
...
@Component({
  selector: 'app-singlebyurl',
  templateUrl: './singlebyurl.component.html',
  styleUrl: './singlebyurl.component.scss',
  encapsulation: ViewEncapsulation.None, // Disabilita l'incapsulamento degli stili
  changeDetection: ChangeDetectionStrategy.OnPush,
  standalone: true,
  providers: [SingleByUrlService],
  imports: [
    MatButtonModule,
    MatCardModule,
    MatChipsModule,
...
export class SingleByUrlComponent {
  ...
  codeBlock1 = `<` + `script>
    function mainDymerView() {
        drawEntityByIdUrl("#cont-MyList", 'e_id');
    }
<` + `/script>`;
