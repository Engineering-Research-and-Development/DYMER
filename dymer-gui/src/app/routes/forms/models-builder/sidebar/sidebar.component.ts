...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, DragDropModule, MatIconModule, PropertiesModelsComponent],
  templateUrl: './sidebar.component.html',
})

export class SidebarModelsComponent {
  pageService = inject(PageService);
  builderService = inject(BuilderService);

  requestCreatePage = output<void>();
  requestAttachFile = output<string>();
  requestEditModel = output<any>();
...
searchQuery = signal('');
  ...
  /**/
  onEditModel(page: any) {
  this.requestEditModel.emit(page);
}
}
